            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h3 class="section-title"><?php echo e(__('Edit user')); ?></h3>
                        </div>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                            <div class="col-6 text-right">
                                <a class="btn btn-primary btn-sm" href="<?php echo e(route('users.index', ['page'=>Session::get('page', 1)])); ?>"><?php echo e(__('Users')); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                ...
                                <?php echo Form::select('roles[]', $roles, $userRole, array('id'=>'roles2', 'class' => 'form-control'.($errors->has('role')?' is-invalid':''),'multiple')); ?>
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="form-row">
                                    <div class="col-md-12 col-lg-12 mb-3">
                                        ...
                                        <?php echo Form::select('roles[]', $roles, $userRole, array('id'=>'role', 'class' => 'form-control'.($errors->has('role')?' is-invalid':''),'multiple', 'size'=>5)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\pachva_a\resources\views/users/edit.blade.php ENDPATH**/ ?>