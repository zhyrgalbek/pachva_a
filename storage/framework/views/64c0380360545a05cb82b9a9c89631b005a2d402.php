                        ...
                        <form method="POST" action="<?php echo e(route('register')); ?>" onsubmit="return validateForm()">
                            ...
                            <fieldset class="border p-2">
                                ...
                                <div class="input-group">
                                    <?php echo Form::select('user_type', array('1' => __('Individual'), '2' => __('Stock')), old('user_type') ?: (in_array('entity', array_keys($_GET)) ? 2 : 1), array('id'=>'user_type', 'required', 'class' => 'form-control'.($errors->has('user_type')?' is-invalid':''), 'data-switcher')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 mb-3">
                                        <?php echo Form::text('middle_name', old('middle_name'), array('id'=>'middle_name', 'placeholder' => __('Middle name'),'class' => 'form-control'.($errors->has('middle_name')?' is-invalid':''))); ?>
...
unset($__errorArgs, $__bag); ?>
                                        <small id="pinHelp" class="form-text text-muted text-right"><?php echo e(__('PIN will be your login')); ?></small>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="input-group">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="input-group">
                                            <?php echo Form::text('phone', old('phone'), array('id'=>'phone', 'required',  'maxlength' => '13' , 'placeholder' => __('Phone'),'class' => 'form-control'.($errors->has('phone')?' is-invalid':''))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/soil_analysis/resources/views/auth/register.blade.php ENDPATH**/ ?>