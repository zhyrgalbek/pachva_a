    ...
    <div class="container" style="display: flex;align-items: center;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li <?php if(request()->routeIs('certificates_data')): ?> class="active" <?php endif; ?>><a class="nav-link" href="<?php echo e(route('certificates_data')); ?>"><?php echo e(__('Registers of certificates')); ?></a></li>
                <li <?php if(request()->routeIs('classWarehouse')): ?> class="active" <?php endif; ?>><a class="nav-link" href="<?php echo e(route('classWarehouse')); ?>"><?php echo e(__('Classes of commodity warehouse')); ?></a></li>
                <li <?php if(request()->routeIs('about')): ?> class="active" <?php endif; ?>><a class="nav-link" href="<?php echo e(route('about')); ?>"><?php echo e(__('About project')); ?></a></li>
            </ul>
...
<?php /**PATH /var/www/html/sklads/resources/views/layouts/navbarGuest.blade.php ENDPATH**/ ?>