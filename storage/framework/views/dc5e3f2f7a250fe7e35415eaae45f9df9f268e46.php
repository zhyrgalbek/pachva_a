...
<head>
    ...
    <script src="<?php echo config('assets.version') ? asset('js/app.js') . '?v=' . config('assets.version') : asset('js/app.js'); ?>" defer></script>
    <link rel="dns-prefetch" href="//fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('images/sklad-logo-1.jpeg')); ?>">
    ...
    <script src="<?php echo config('assets.version') ? asset('js/custom.js') . '?v=' . config('assets.version') : asset('js/custom.js'); ?>" defer></script>
</head>
            ...
            <div class="container">
                <div class="row">
                    <?php if(request()->routeIs('services.contact')): ?>
                        <?php echo $__env->make('layouts.banners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('layouts.advantages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('layouts.news', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('layouts.financeLiteracy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('layouts.partners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                    <?php echo $__env->make('layouts.portal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/html/sklads/resources/views/layouts/app.blade.php ENDPATH**/ ?>