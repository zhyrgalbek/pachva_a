                ...
                <div class="card">
                    <div class="card-header text-center bg-white border-b-0">
                        ...
                        @if(session()->has('error'))
                            <p class="alert alert-danger">{{ __(session('error')) }}</p>
                        @endif
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" onsubmit="return validateForm()">
                            ...
                            <fieldset class="border p-2">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-12 mb-3">
                                        {!! Form::text('middle_name', old('middle_name'), array('id'=>'middle_name', 'required', 'placeholder' => __('Middle name'),'class' => 'form-control'.($errors->has('middle_name')?' is-invalid':''))) !!}
                                        @error('middle_name')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="col-12 mb-3">
                                        {!! Form::text('identifier', old('identifier'), array('id'=>'identifier', 'required', 'maxlength' => 14, 'placeholder' => __('INN/PIN'),'class' => 'form-control'.($errors->has('identifier')?' is-invalid':''))) !!}
                                        @error('identifier')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        @enderror
                                        <small id="pinHelp" class="form-text text-muted text-right">{{__('PIN will be your login')}}, {{ __('contains 14 digits') }}</small>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3 emailInput">
                                        <div class="input-group">
                                            {!! Form::email('email', old('email'), array('id'=>'email', 'placeholder' => __('E-Mail Address'),'class' => 'form-control'.($errors->has('email')?' is-invalid':''))) !!}
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="input-group">
                                            {!! Form::text('phone', old('phone'), array('id'=>'phone', 'required',  'maxlength' => '13' , 'placeholder' => '996 700 000 000','class' => 'form-control'.($errors->has('phone')?' is-invalid':''))) !!}
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="input-group">
                                            {!! Form::password('password', array('value'=> old('password'), 'id'=>'password', 'required', 'placeholder' => __('Password'),'class' => 'form-control'.($errors->has('password')?' is-invalid':''))) !!}
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="input-group">
                                            {!! Form::password('password_confirmation', array('value'=> old('password_confirmation'), 'id'=>'password_confirmation', 'required', 'placeholder' => __('Confirm Password'),'class' => 'form-control'.($errors->has('password_confirmation')?' is-invalid':''))) !!}
                                            <div class="input-group-append">
                                    ...
                                    <!-- <div class="col-12 mb-3">
                                      <div class="ps-4">
                                          ...
                                          <label class="form-check-label" for="process_personal_data">
                                              {{ __('Permission to process personal data') }}
