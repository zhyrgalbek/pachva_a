            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h3 class="section-title">{{__('User')}}</h3>
                        </div>
                        @can('user-list')
                            <div class="col-6 text-right">
                                <a class="btn btn-primary btn-sm" href="{{ route('users.index', ['page'=>Session::get('page', 1)]) }}">{{__('Back')}}</a>
                            </div>
                        @endcan
                    </div>
                </div>
                    ...
                    {!! Form::model($user, ['route' => ['users.update', $user->id]]) !!}
                        ...
                        <fieldset class="border p-2" disabled>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <label for="sbk_user_id">{{__('SBK ID')}}:</label>
                                    {!! Form::text('sbk_user_id', null, array('id'=>'sbk_user_id','class' => 'form-control')) !!}
                                </div>
                                <div class="col-md-6 col-lg-4 mb-3">
