            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h3 class="section-title">{{__('Create user')}}</h3>
                        </div>
                        @can('user-list')
                            <div class="col-6 text-right">
                                <a class="btn btn-primary btn-sm" href="{{ route('users.index') }}">{{__('Users')}}</a>
                            </div>
                        @endcan
                    </div>
                </div>
                    ...
                    <fieldset class="border p-2" data-user_type="1">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                ...
                                {!! Form::select('roles[]', $roles, [], array('id'=>'roles2', 'class' => 'form-control'.($errors->has('role')?' is-invalid':''),'multiple')) !!}
                                @error('roles')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="form-row">
                                    <div class="col-md-12 col-lg-12 mb-3">
                                        ...
                                        {!! Form::select('roles[]', $roles, [], array('id'=>'role', 'class' => 'form-control'.($errors->has('role')?' is-invalid':''),'multiple', 'size'=>5)) !!}
                                        @error('roles')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
