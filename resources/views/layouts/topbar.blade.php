<nav class="navbar navbar-expand navbar-light navbar-bg navbar-cabinet">
    ...
    {!! Form::open(array('route' => 'services.index','method'=>'GET', 'class'=>'d-none d-sm-inline-block', 'data-form-nullable')) !!}
        <div class="input-group input-group-navbar">
            @if (isset($search))
                {!! Form::text('search', $search, array('data-param'=> 'search', 'placeholder' => __('Search services'), 'aria-label'=>__('Search'), 'class' => 'form-control')) !!}
            @else
                {!! Form::text(null, null, array('data-param'=> 'search', 'placeholder' => __('Search services'), 'aria-label'=>__('Search'), 'class' => 'form-control')) !!}
            @endif
            ...
            <li class="nav-item dropdown">
                <a id="navbarDropdown" class="nav-link user-icon" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    <div class="row align-items-center vertical" data-tooltip="tooltip" data-placement="bottom" title="{{ __('User') }}">
                        ...
                        <span class="d-block">{{ Auth::user()->last_name }} {{ Auth::user()->name }}</span>
                        <span class="text-black-50 text-sm d-block lh-1">{{ implode(', ', array_map('__', Auth::user()->roles->pluck('name')->all())) }}</span>
                        </div>
...
{{--                    @endcan--}}
            ...
            <li class="nav-item dropdown">
                <a class="nav-icon dropdown-toggle" id="messagesDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    <div class="position-relative" data-tooltip="tooltip" data-placement="bottom" title="{{ __('Messages') }}">
            ...
            <li class="nav-item dropdown">
                <a class="nav-icon dropdown-toggle" id="alertsDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    <div class="position-relative" data-tooltip="tooltip" data-placement="bottom" title="{{ __('Alerts') }}">
            ...
            <li class="nav-item dropdown">
                <a class="nav-flag dropdown-toggle" href="#" id="navbarDropdownLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div data-tooltip="tooltip" data-placement="bottom" title="{{ Config::get('languages')[App::getLocale()]['display'] }}">
